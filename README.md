...
Для корректной работы приложения необходимо настроить подключение к серверу и отправку шести видов JSON-сообщений. Ознакомится с примером можно по [ссылке](https://github.com/Tiliss/ViewRouteJSON).
